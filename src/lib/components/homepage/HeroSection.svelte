		...
		<div class="mt-16 grid gap-4 sm:grid-cols-2 lg:mt-20">
			...
			<div class="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-shadow hover:shadow-lg">
				...
				<div class="mt-3 grid grid-cols-3 gap-2">
					<img src="https://gallery.bingwuai.com/hero-1_compressed.jpeg" alt="AI 生成的水彩猫咪画作" class="aspect-square rounded-lg object-cover" loading="lazy" />
					<img src="https://gallery.bingwuai.com/hero-2_compressed.jpeg" alt="AI 生成的水彩猫咪画作" class="aspect-square rounded-lg object-cover" loading="lazy" />
					<img src="https://gallery.bingwuai.com/hero-3_compressed.jpeg" alt="AI 生成的水彩猫咪画作" class="aspect-square rounded-lg object-cover" loading="lazy" />
				</div>
			</div>
